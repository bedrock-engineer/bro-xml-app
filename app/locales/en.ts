export default {
  translation: {
    ...
    particleSizeAxisLabel: "Particle size (μm)",
    cumulativePassingAxisLabel: "Cumulative passing (%)",
    dryDensityAxisLabel: "Dry density ρd (g/cm³)",
    permeabilityAxisLabel: "Permeability k (m/s)",
    horizontalDisplacementAxisLabel: "Horizontal displacement δh (mm)",
    shearStressAxisLabel: "Shear stress τ (kPa)",
    normalStressAxisLabel: "Normal stress σn (kPa)",
    peakShearStressAxisLabel: "Peak shear stress τf (kPa)",
    heightChangeAxisLabel: "Height change (mm)",
    verticalStressAxisLabel: "Vertical stress σ'v (kPa)",
    verticalStrainAxisLabel: "Vertical strain ε (%)",
    axialStrainAxisLabel: "Axial strain ε₁ (%)",
    deviatorStressAxisLabel: "Deviator stress q (kPa)",
    mohrNormalStressAxisLabel: "Normal stress σ (kPa)",
    porePressureAxisLabel: "Pore pressure u (kPa)",
    mohrEffectiveLegend: "dashed: effective stress σ′",
    aLineLabel: "A-line",
    uLineLabel: "U-line",
    liquidLimitAxisLabel: "Liquid Limit (%)",
    plasticityIndexAxisLabel: "Plasticity Index (%)",
    ...
    sand: "Sand",
    sandFine: "Sand (fine)",
    sandMedium: "Sand (medium)",
    sandCoarse: "Sand (coarse)",
    clay: "Clay",
    peat: "Peat",
    silt: "Silt",
    siltSoil: "Silt",
    ...
    soilNotSpecified: "Soil not specified",
